...
class HomePage(Page):
    ...
    hero_txt_studio = models.CharField("Footer: Riga 1 (grigio)", max_length=200, default="STUDIO")
    hero_txt_legale = models.CharField("Footer: Riga 2 (grigio)", max_length=200, default="LEGALE")
    hero_txt_accent = models.CharField("Footer: Riga 3 (bianco + apostrofo accent)", max_length=100, default="D'ONOFRIO")
